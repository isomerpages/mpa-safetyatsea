...
<div class="speaker-name text-ellipsis"><strong>CDR Peter Bizzaro's Presentation Slides</strong> 
	<a href="/files/Presentation/SESSION_1_PANEL_2/CDR_Peter_Bizzaro_s_Presentation_Slides.pdf" target="_new" class="ml-3">CLICK HERE <i class="sgds-icon sgds-icon-arrow-right is-size-4 ml-5"></i></a>	</div>
