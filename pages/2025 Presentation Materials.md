...
<div>
  <h3>International Safety@Sea Conference – Plenary 2</h3>
	<h3>From Incident to Insight: Unpacking Lessons for a Safer Maritime Industry</h3>
</div>
<div class="mb-5 pb-5">
<hr class="my-5">	
...
<div class="text-ellipsis speaker-company mb-3">BIMCO</div>
...
<div>
  <h3>International Safety@Sea Conference – Plenary 3</h3>
	<h3>The Human Element: Ensuring Safety in Maritime’s Transition</h3>
</div>
<div class="mb-5 pb-5">
<hr class="my-5">	
...
<div class="speaker-name text-ellipsis"><strong class="mr-5">Mr Darrick Leow’s Presentation Slides:</strong> 
	<a href="/files/Presentation 2025/Mr_Darrick_Leow___Supporting_the_Safe_Transition_of_Seafarers_and_Personnel_in_Maritime_Decarbonisation.pdf" target="_new" class="ml-5">CLICK HERE <i class="sgds-icon sgds-icon-arrow-right is-size-4 ml-3"></i></a>	</div>
